...
{
    // copied from https://github.com/nlhans/ets2-sdk-plugin/blob/2e0b68553d6d6181ccf7be99f1a512d63fc4d231/ets2-client/C%23/Ets2SdkClient/Ets2Telemetry.cs
    ...
    public class Ets2Telemetry
    {
        ...
        public Ets2Telemetry(Ets2TelemetryData raw, Ets2SdkUnmanaged rawUnmanaged)
        {
            ...
            Lights.BlinkerLeftActive = raw.GetBool(Ets2SdkBoolean.BlinkerLeftActive);
            Lights.BlinkerLeftOn = raw.GetBool(Ets2SdkBoolean.BlinkerLeftOn);
            Lights.BlinkerRightActive = raw.GetBool(Ets2SdkBoolean.BlinkerRightActive);
            Lights.BlinkerRightOn = raw.GetBool(Ets2SdkBoolean.BlinkerRightOn);
            Lights.BrakeLight = raw.GetBool(Ets2SdkBoolean.LightsBrake);
            Lights.FrontAux = raw.GetBool(Ets2SdkBoolean.LightsAuxFront);
            Lights.HighBeams = raw.GetBool(Ets2SdkBoolean.LightsBeamHigh);
            Lights.LightsDashboard = raw.lightsDashboard;
            Lights.LowBeams = raw.GetBool(Ets2SdkBoolean.LightsBeamLow);
            Lights.ParkingLights = raw.GetBool(Ets2SdkBoolean.LightsParking);
            Lights.ReverseLight = raw.GetBool(Ets2SdkBoolean.LightsReverse);
            Lights.RoofAux = raw.GetBool(Ets2SdkBoolean.LightsAuxRoof);
            */
            #endregion
        }
    }
